...
```{r echo=FALSE, fig.height=hval, fig.width=hval}
  ...
  heatmap.2(as.matrix(asratio), col=cpalette, margin=c(hval,hval), density.info = "none", trace = "none", key.xlab = "ASratio", cexRow = 1.5, cexCol = 1.5, keysize = 1)
```
...
```{r echo=FALSE, fig.height=hval, fig.width=hval}
  heatmap.2(as.matrix(rdCntAvgLog), col=cpalette, margin=c(hval,hval), density.info = "none", trace = "none", key.xlab = "log2(readCountsAvg)", cexRow = 1.5, cexCol = 1.5, keysize = 1)
```
